package org.muellners.finscale.identity.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.muellners.finscale.identity.repository..*)" +
            " || within(org.muellners.finscale.identity.service..*)" +
            " || within(org.muellners.finscale.identity.web.rest..*)"
    )
