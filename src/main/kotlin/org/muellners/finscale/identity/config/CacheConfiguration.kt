...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("identity")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "identity"
        ...
        config.mapConfigs["org.muellners.finscale.identity.domain.*"] = initializeDomainMapConfig(jHipsterProperties)
